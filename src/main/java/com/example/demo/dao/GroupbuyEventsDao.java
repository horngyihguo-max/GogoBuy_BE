...
public interface GroupbuyEventsDao extends JpaRepository<GroupbuyEvents, Integer> {
	...
	public int addEvent( String hostId, int storesId, String status, LocalDateTime endTime, 
			Integer totalOrderAmount, Integer shippingFee, String splitType, 
			String announcement, String type, String temp_menu,String recommend, 
